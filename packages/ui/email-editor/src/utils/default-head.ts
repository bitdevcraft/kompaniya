...
const DEFAULT_FONT_FAMILY =
  '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Noto Sans", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif';
...
const DEFAULT_EMAIL_CSS = `/* Email-safe modern CSS baseline + small utility set (Tailwind-like) */
...
const DEFAULT_MJ_CLASSES: MjmlJsonNode[] = [
  mjClass("text-xs", { "font-size": "12px" }),
  mjClass("text-sm", { "font-size": "14px" }),
  mjClass("text-base", { "font-size": "16px" }),
  mjClass("text-lg", { "font-size": "18px" }),
  mjClass("text-xl", { "font-size": "20px" }),
  mjClass("text-2xl", { "font-size": "24px" }),
  mjClass("text-3xl", { "font-size": "30px" }),
  mjClass("text-muted", { color: COLORS.muted }),
  mjClass("text-primary", { color: COLORS.primary }),
  mjClass("text-invert", { color: COLORS.primaryContrast }),
  mjClass("leading-tight", { "line-height": "1.25" }),
  mjClass("leading-normal", { "line-height": "1.6" }),
  mjClass("leading-relaxed", { "line-height": "1.8" }),
  mjClass("font-normal", { "font-weight": "400" }),
  mjClass("font-medium", { "font-weight": "500" }),
  mjClass("font-semibold", { "font-weight": "600" }),
  mjClass("font-bold", { "font-weight": "700" }),
  mjClass("text-left", { align: "left" }),
  mjClass("text-center", { align: "center" }),
  mjClass("text-right", { align: "right" }),
  mjClass("mt-0", { "padding-top": "0" }),
  mjClass("mt-1", { "padding-top": "4px" }),
  mjClass("mt-2", { "padding-top": "8px" }),
  mjClass("mt-3", { "padding-top": "12px" }),
  mjClass("mt-4", { "padding-top": "16px" }),
  mjClass("mt-6", { "padding-top": "24px" }),
  mjClass("mt-8", { "padding-top": "32px" }),
  mjClass("mb-0", { "padding-bottom": "0" }),
  mjClass("mb-1", { "padding-bottom": "4px" }),
  mjClass("mb-2", { "padding-bottom": "8px" }),
  mjClass("mb-3", { "padding-bottom": "12px" }),
  mjClass("mb-4", { "padding-bottom": "16px" }),
  mjClass("mb-6", { "padding-bottom": "24px" }),
  mjClass("mb-8", { "padding-bottom": "32px" }),
  mjClass("pt-0", { "padding-top": "0" }),
  mjClass("pt-2", { "padding-top": "8px" }),
  mjClass("pt-4", { "padding-top": "16px" }),
  mjClass("pt-6", { "padding-top": "24px" }),
  mjClass("pb-0", { "padding-bottom": "0" }),
  mjClass("pb-2", { "padding-bottom": "8px" }),
  mjClass("pb-4", { "padding-bottom": "16px" }),
  mjClass("pb-6", { "padding-bottom": "24px" }),
  mjClass("px-0", { "padding-left": "0", "padding-right": "0" }),
  mjClass("px-2", { "padding-left": "8px", "padding-right": "8px" }),
  mjClass("px-4", { "padding-left": "16px", "padding-right": "16px" }),
  mjClass("px-6", { "padding-left": "24px", "padding-right": "24px" }),
  mjClass("py-0", { "padding-top": "0", "padding-bottom": "0" }),
  mjClass("py-2", { "padding-top": "8px", "padding-bottom": "8px" }),
  mjClass("py-4", { "padding-top": "16px", "padding-bottom": "16px" }),
  mjClass("py-6", { "padding-top": "24px", "padding-bottom": "24px" }),
  mjClass("p-0", { padding: "0" }),
  mjClass("p-2", { padding: "8px" }),
  mjClass("p-4", { padding: "16px" }),
  mjClass("p-6", { padding: "24px" }),
  mjClass("w-full", { width: "100%" }),
  mjClass("max-w-640", { width: "640px" }),
  mjClass("max-w-480", { width: "480px" }),
  mjClass("rounded", { "border-radius": "10px" }),
  mjClass("rounded-lg", { "border-radius": "14px" }),
  mjClass("rounded-full", { "border-radius": "999px" }),
  mjClass("border", { border: `1px solid ${COLORS.border}` }),
  mjClass("border-0", { border: "0" }),
  mjClass("shadow", {
    "box-shadow":
      "0 1px 2px rgba(17,24,39,0.04), 0 4px 12px rgba(17,24,39,0.06)",
  }),
  mjClass("bg-surface", { "background-color": COLORS.surface }),
  mjClass("bg-muted", { "background-color": "#f3f4f6" }),
  mjClass("bg-primary", {
...
export const DEFAULT_HEAD_CHILDREN: MjmlJsonNode[] = [
  {
  ...
  {
    tagName: "mj-style",
    content: DEFAULT_EMAIL_CSS,
  },
];

export const DEFAULT_HEAD_NODE: MjmlJsonNode = {
  tagName: "mj-head",
  attributes: {},
  children: DEFAULT_HEAD_CHILDREN,
};

export const buildDefaultHeadNode = (
  extraChildren: MjmlJsonNode[] = [],
  attributes: Record<string, string> = {},
): MjmlJsonNode => ({
  tagName: "mj-head",
  attributes,
  children: [...DEFAULT_HEAD_CHILDREN, ...extraChildren],
});
