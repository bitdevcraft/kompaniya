  ...
  sections: [
    {
      ...
      fields: [
        ...
        { id: "phone", label: "Phone", placeholder: "+1 (555) 000-0000", type: "text" },
        { id: "websiteUrl", label: "Website", placeholder: "https://", type: "text" },
    ...
    {
      description: "Track the last touchpoint and upcoming follow-up for this contact.",
      fields: [
        {
        ...
        {
          colSpan: 2,
          description: "Internal notes that stay with the team—customers never see these.",
          id: "notes",
    ...
    {
      description: "Classify the contact for list building, segmentation, and personalization.",
      fields: [
        {
          colSpan: 2,
          description: "Comma or line separated tags make it easy to drive automations.",
          id: "tags",
          label: "Tags",
    ...
    {
      description: "How this contact prefers to hear from us and their current consent status.",
      fields: [
        ...
        { id: "consentCapturedAt", label: "Consent captured", type: "datetime" },
    ...
    {
      columns: 2,
      description: "Billing information that syncs with invoices and payment records.",
      fields: [
    ...
    {
      description: "System metadata used for deduplication and downstream integrations.",
      fields: [
        { id: "dedupeKey", label: "Dedupe key", type: "text" },
      ],
      id: "system",
