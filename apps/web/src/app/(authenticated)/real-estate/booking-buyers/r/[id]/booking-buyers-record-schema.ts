...
export const bookingBuyerRecordSchema = z.object({
  bookingId: z.string().optional(),
  contactId: z.string().optional(),
  isPrimaryBuyer: z.boolean().optional(),
  createdAt: z.string().optional(),
  updatedAt: z.string().optional(),
  customFields: z.record(z.string(), z.unknown()).optional(),
});

export type BookingBuyerRecordFormValues = z.input<
  typeof bookingBuyerRecordSchema
>;
export type BookingBuyerRecordSubmitValues = z.output<
  typeof bookingBuyerRecordSchema
>;

export function createBookingBuyerFormDefaults(
  record: OrgRealEstateBookingBuyer,
  layout: RecordPageLayout<BookingBuyerRecordFormValues>,
): BookingBuyerRecordFormValues {
  ...
  return defaults as BookingBuyerRecordFormValues;
}

export function createBookingBuyerUpdatePayload(
  record: OrgRealEstateBookingBuyer,
  values: BookingBuyerRecordSubmitValues,
  layout: RecordPageLayout<BookingBuyerRecordFormValues>,
): Partial<OrgRealEstateBookingBuyer> {
  const updates: Partial<OrgRealEstateBookingBuyer> = {};
