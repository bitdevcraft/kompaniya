...
export function useDataTableColumns(
  setRowAction: React.Dispatch<
    React.SetStateAction<DataTableRowAction<OrgRealEstatePaymentPlan> | null>
  >,
) {
  ...
  const columns: ColumnDef<OrgRealEstatePaymentPlan>[] = [
    {
      id: "select",
      header: ({ table }) => (
        <Checkbox
  ...
  return getTableColumns<OrgRealEstatePaymentPlan>({ setRowAction, columns });
}
