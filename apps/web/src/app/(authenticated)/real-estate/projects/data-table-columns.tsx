...
export function useDataTableColumns(
  setRowAction: React.Dispatch<
    React.SetStateAction<DataTableRowAction<OrgRealEstateProject> | null>
  >,
) {
  ...
  const columns: ColumnDef<OrgRealEstateProject>[] = [
    {
      id: "select",
      header: ({ table }) => (
        <Checkbox
  ...
  return getTableColumns<OrgRealEstateProject>({ setRowAction, columns });
}
