...
export function useDataTableColumns(
  setRowAction: React.Dispatch<
    React.SetStateAction<DataTableRowAction<OrgRealEstateBookings> | null>
  >,
) {
  ...
  const columns: ColumnDef<OrgRealEstateBookings>[] = [
    {
      id: "select",
      header: ({ table }) => (
        <Checkbox
  ...
  return getTableColumns<OrgRealEstateBookings>({ setRowAction, columns });
}
