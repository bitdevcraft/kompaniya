...
export const emailClickRecordSchema = z.object({
...
export type EmailClickRecordFormValues = z.input<typeof emailClickRecordSchema>;
export type EmailClickRecordSubmitValues = z.output<
  typeof emailClickRecordSchema
>;

export function createEmailClickFormDefaults(
  record: OrgEmailClick,
  layout: RecordPageLayout<EmailClickRecordFormValues>,
): EmailClickRecordFormValues {
  ...
  return defaults as EmailClickRecordFormValues;
}

export function createEmailClickUpdatePayload(
  record: OrgEmailClick,
  values: EmailClickRecordSubmitValues,
  layout: RecordPageLayout<EmailClickRecordFormValues>,
): Partial<OrgEmailClick> {
  const updates: Partial<OrgEmailClick> = {};
