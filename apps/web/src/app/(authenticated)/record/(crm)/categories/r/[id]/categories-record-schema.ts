...
export type CategoryRecordFormValues = z.input<typeof categoryRecordSchema>;
export type CategoryRecordSubmitValues = z.output<typeof categoryRecordSchema>;

export function createCategoryFormDefaults(
  record: OrgCategory,
  layout: RecordPageLayout<CategoryRecordFormValues>,
): CategoryRecordFormValues {
  ...
  return defaults as CategoryRecordFormValues;
}

export function createCategoryUpdatePayload(
  record: OrgCategory,
  values: CategoryRecordSubmitValues,
  layout: RecordPageLayout<CategoryRecordFormValues>,
): Partial<OrgCategory> {
  const updates: Partial<OrgCategory> = {};
